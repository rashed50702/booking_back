    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <span class="dropdown-item dropdown-header">15 Booking Requests</span>
        ...
        <li class="nav-item">
            <a class="nav-link text-danger" title="Logout" href="{{ route('logout') }}" onclick="event.preventDefault();
